...
function canBeFormedFast($string, $set) {
    $len = strlen($string);
...
function getMinimalSetOptimized($strings) {
    ...
    foreach ($strings as $str) {
        ...
        if (!canBeFormedFast($str, $hashSet)) {
...
// Example Usage
$strings = ["apple", "app", "le", "banana", "an", "ban", "na"];
$minimalSet = getMinimalSetOptimized($strings);
